...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="{{asset('web_style/AmazeUI-2.4.2/assets/js/amazeui.js')}}"></script>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="{{asset('web_style/images/songzi.jpg')}}" />
													</div>
													<div class="text-info">
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="{{asset('web_style/images/browse1.jpg')}}"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										...
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="{{asset('web_style/images/hwbn40x40.jpg')}}" />
												<!-- 评论者头像 -->
											</a>
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														...
														<!-- 评论者 -->
														评论于
														<time datetime="">{{$v['updated_at']}}</time>
													</div>
												</header>
						...
						<div id="prof" class="item">
							...
							<div class="ibar_login_box status_login">
								<div class="avatar_box">
									<p class="avatar_imgbox"><img src="{{asset('web_style/images/no-img_mid_.jpg')}}" /></p>
									<ul class="user_info">
										<li>用户名：sl1903</li>
										<li>级&nbsp;别：普通会员</li>
									</ul>
